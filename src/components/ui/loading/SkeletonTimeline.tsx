        ...
        {Array.from({ length: count }, (_, index) => (
          <div className="grid grid-cols-[28px_1fr] gap-4" key={index}>
            <div className="relative flex justify-center">
              <span className="mogcia-skeleton h-3 w-3 rounded-xl" />
              {index < count - 1 ? <span className="absolute top-5 h-16 w-px bg-[#E2E8F0]" /> : null}
            </div>
            <div className="space-y-3 rounded-xl border border-[#F5ECEE] bg-[#FFFFFF] p-4">
